...
std::string Message::receivePath()
{
	if (containsKey("receivePath"))
	{
		return attributes_["receivePath"];
	}
	return "";
}
//----< set command attribute >----------------------------------------

void Message::receivePath(const std::string& path)
{
	attributes_["receivePath"] = path;
}


//----< get command attribute >----------------------------------------

std::string Message::sendPath()
{
	if (containsKey("sendPath"))
	{
		return attributes_["sendPath"];
	}
	return "";
}
//----< set command attribute >----------------------------------------

void Message::sendPath(const std::string& path)
{
	attributes_["sendPath"] = path;
}
...
//----< extracts value for specified attribute  >-------------------------

std::string Message::getValueForAttribute(const std::string& attr)
{
	if (containsKey(attr))
	{
...
void Message::setValueForAttribute(const std::string& attr, const std::string& val) {
