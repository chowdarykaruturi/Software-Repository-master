...
namespace MsgPassingCommunication
{
  ...
  public:
	...
	void receivePath(const std::string& path);
	std::string sendPath();
	...
	std::string getValueForAttribute(const std::string& attr);
	void setValueForAttribute(const std::string& attr, const std::string& val);
    void clear();
    std::string toString();
